...
## 🚀 Conclusions
In this repository, we have provided codes to implement our automated stepsize approach in a fully distributed manner using three machine learning tasks on benchmark datasets. Compared with existing adaptive/nonadpative algorithms, our approach achives a faster convergence speed and a higher learning accuracy. In addition, to reduce communication complexity, we have also provided an asynchronous-parallel-update implementation of our approach, which achieves the lowest communication rounds and wallclock time compared with existing couterpart algorithms. To the best of our knowledge, it is the first to completely avoid manual stepsize adjustment in decentralized machine learning tasks without the assistant of any centralized aggregators or information of the global objective function. Given its tuning-free nature and demonstrated performance, our approach is highly applicable to serving as a baseline for other distributed algorithms in machine learning tasks.
