...
from matrix import CONST_Q, K_LOOP, finite_consensus, imperfect_consensus,Subrounte1
...
class Algorithm2(Trainer):
    ...
    def step(self, iteration):
        ...
        x = imperfect_consensus(x, K_LOOP, self.agent_matrix,self.agents)
        ...
        y = imperfect_consensus(y, K_LOOP, self.agent_matrix,self.agents)
...
class DBBC(Trainer):
    def __init__(self, *args, **kwargs):
        super(DBBC, self).__init__(*args, **kwargs)
        self.name = "DBBC"
        self.agent_y = {}
